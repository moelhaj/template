...
export default function Hero() {
	return (
		<div className="min-h-screen flex flex-col lg:flex-row text-white relative">
			<div className="absolute inset-0 w-full z-20 bg-gradient-to-r from-cyan-500 to-blue-500" />
			...
			<div className="relative z-40 flex-1 p-4 flex flex-col gap-4 items-center justify-center lg:justify-start bg-gray-100 ">
				...
				<div className="flex gap-4 mt-56">
					<Button className="rounded-lg h-10 bg-blue-600 text-white">Apply Now</Button>
					<Button
